...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('enrol_begateway/begatewayshop_id', get_string('shop_id', 'enrol_begateway'), get_string('shop_id_desc', 'enrol_begateway'), '', PARAM_TEXT));

    $settings->add(new admin_setting_configtext('enrol_begateway/begatewayshop_key', get_string('shop_key', 'enrol_begateway'), get_string('shop_key_desc', 'enrol_begateway'), '', PARAM_TEXT));

    $settings->add(new admin_setting_configtext('enrol_begateway/begatewaydomain_checkout', get_string('domain_checkout', 'enrol_begateway'), get_string('domain_checkout_desc', 'enrol_begateway'), '', PARAM_TEXT));

    $settings->add(new admin_setting_configtext('enrol_begateway/begatewaydomain_gateway', get_string('domain_gateway', 'enrol_begateway'), get_string('domain_gateway_desc', 'enrol_begateway'), '', PARAM_TEXT));

    $settings->add(new admin_setting_configtext('enrol_begateway/begatewaydomain_api', get_string('domain_api', 'enrol_begateway'), get_string('domain_api_desc', 'enrol_begateway'), '', PARAM_TEXT));

    $settings->add(new admin_setting_configcheckbox('enrol_begateway/enable_card', get_string('enable_card', 'enrol_begateway'), '', PARAM_TEXT));
    
    $settings->add(new admin_setting_configcheckbox('enrol_begateway/enable_erip', get_string('enable_erip', 'enrol_begateway'), '', PARAM_TEXT));

    $settings->add(new admin_setting_configtext('enrol_begateway/begatewayerip_service_no', get_string('erip_service_no', 'enrol_begateway'), get_string('erip_service_no_desc', 'enrol_begateway'), '', PARAM_TEXT));
