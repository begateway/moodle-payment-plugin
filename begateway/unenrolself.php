...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'begateway'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/begateway/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_begateway', format_string($course->fullname));
